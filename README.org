...
Script supposed to suggest missing indexes to be crated to improve performance.
...
Script to create missing indexes on FK columns.  (Caution -- For performance
reason, not all FK needs to be indexed!)
