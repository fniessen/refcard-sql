...
SQL script to *help identifying* ways to increase performance based on the most
...
*re-building primary key indexes*, this is the best tool we've seen for *speeding
up performance* in SQL Server queries, *from minutes down to seconds*.
